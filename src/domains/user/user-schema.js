...
const userCreateSchema = Joi.object({
	...
	role: Joi.string().valid("USER", "ADMIN", "SUPER_ADMIN").default("USER"), // ✅ sesuai Prisma
	...
	position_id: Joi.string().uuid().required().messages({
...
const userUpdateSchema = Joi.object({
	...
	role: Joi.string().valid("USER", "ADMIN", "SUPER_ADMIN").optional().allow(""),
